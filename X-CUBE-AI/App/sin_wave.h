/**
  ...
  ******************************************************************************
  */
#ifndef AI_SIN_WAVE_H
#define AI_SIN_WAVE_H

#include "sin_wave_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SIN_WAVE_MODEL_NAME          "sin_wave"
#define AI_SIN_WAVE_ORIGIN_MODEL_NAME   "sine_model"

/******************************************************************************/
#define AI_SIN_WAVE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SIN_WAVE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SIN_WAVE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SIN_WAVE_IN_NUM        (1)

AI_DEPRECATED
#define AI_SIN_WAVE_IN \
  ai_sin_wave_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SIN_WAVE_IN_SIZE { \
  AI_SIN_WAVE_IN_1_SIZE, \
}
#define AI_SIN_WAVE_IN_SIZE_BYTES { \
  AI_SIN_WAVE_IN_1_SIZE_BYTES, \
}
#define AI_SIN_WAVE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SIN_WAVE_IN_1_CHANNEL     (1)
#define AI_SIN_WAVE_IN_1_SIZE        (1)
#define AI_SIN_WAVE_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SIN_WAVE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SIN_WAVE_OUT \
  ai_sin_wave_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SIN_WAVE_OUT_SIZE { \
  AI_SIN_WAVE_OUT_1_SIZE, \
}
#define AI_SIN_WAVE_OUT_SIZE_BYTES { \
  AI_SIN_WAVE_OUT_1_SIZE_BYTES, \
}
#define AI_SIN_WAVE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SIN_WAVE_OUT_1_CHANNEL     (1)
#define AI_SIN_WAVE_OUT_1_SIZE        (1)
#define AI_SIN_WAVE_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SIN_WAVE_N_NODES (5)
 ...
 */
AI_API_ENTRY
ai_handle ai_sin_wave_destroy(ai_handle network);
 ...
 * @ref ai_sin_wave_create. Both the activations memory buffer 
 ...
 * using @ref ai_sin_wave_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sin_wave_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sin_wave_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SIN_WAVE_*
 * defines into file @ref sin_wave.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
